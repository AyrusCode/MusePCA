...
def load_muse_csv_as_raw_AD(filename, sfreq=256., ch_ind=[0, 1, 2, 3],
                         stim_ind=6, replace_ch_names=None, verbose=1):
    """Load CSV files into a Raw object.
...
def load_data(data_dir=None, subject_nb=1, session_nb=1, sfreq=256.,
